...
local redzLib = {
  ...
  Themes = loadstring(game:HttpGet("https://raw.githubusercontent.com/ShadowHub-Lynix/RedzLibV4/refs/heads/main/Themes.lua"))(),
  Flags = {},
  Save = {
    Theme = "Default",
    UISize = {550, 310},
  ...
  Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/ShadowHub-Lynix/RedzLibV4/refs/heads/main/Icons.lua"))() --[[
  ...
  CloseBTN["Activated"]:Connect(function()
    if not WaitMinimize then
      ...
      Window.Dialog:Create({
        Title = "Você tem certeza que deseja fechar o Shadow Hub??,
        Confirm = {
          Text = "Close",
          Callback = function()
  ...
  function Window:MakeTab(Configs)
    ...
    function Tab:AddButton(Configs)
      ...
      local ButtonIcon = insertTheme(Create("ImageLabel", Frame, {
        ...
        BackgroundTransparency = 1,
        Image = "rbxassetid://132904943667961",
