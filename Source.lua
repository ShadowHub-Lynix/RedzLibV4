...
local redzLib = {
  ...
  Themes = loadstring(game:HttpGet("https://raw.githubusercontent.com/lynix-sources/RedzLibV4/refs/heads/main/Themes.lua"))(),
  Flags = {},
  Save = {
    Theme = "Default",
    UISize = {550, 310},
  ...
  Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/lynix-sources/RedzLibV4/main/Icons.lua"))() --[[
  ...
  function Window:MakeTab(Configs)
    ...
    function Tab:AddButton(Configs)
      ...
      local ButtonIcon = insertTheme(Create("ImageLabel", Frame, {
        ...
        BackgroundTransparency = 1,
        Image = "rbxassetid://134958879808698",
